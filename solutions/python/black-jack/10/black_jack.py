...
def higher_card(card_one, card_two):
    ...
    if card_one == "A" and card_one != card_two:
        return card_two
    if card_two == "A" and card_two != card_one :
        return card_one
    if card_one in ["K", "J", "Q"] and card_two == "10":
        return (card_one,card_two)
    if card_two in ["K", "J", "Q"] and card_one == "10":
        return (card_one,card_two)
...
def can_split_pairs(card_one, card_two):
    ...
    if card_one == card_two:
        return True
    if card_one in ["K", "Q", "J", "10"] and card_two in ["K", "Q", "J", "10"]:
        return True
    return False
...
def can_double_down(card_one, card_two):
    ...
    if (card_one == "A") and card_two in ["K", "J", "Q","10", "9", "8", "7", "6", "5","4","3","2"]:
        return True 
    if card_one in ["K", "J", "Q","10", "9", "8", "7", "6", "5","4","3","2"] and (card_two == "A"):
        return True
    return False
